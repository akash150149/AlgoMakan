...
import { ScontrClient, ScontrComposerResults, ScontrFactory } from '../contracts/Scontr'
...
    const factory = new ScontrFactory({
...
    const { appClient } = deployResult
    ...
    // --- FIX IS HERE ---
    // Was: .mintNft()
    // Now: .hello({ args: { name: contractInput } })
...
    }
    ...
    // The 'hello' method returns a string, so this will log the full response
