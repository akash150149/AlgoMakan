...
export type RealEstateAppComposer<TReturns extends [...any[]] = []> = {
  ...
  * Purchase the NFT
   ...
   */
  simulate(): Promise<RealEstateAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<RealEstateAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<RealEstateAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
